...
public partial class BattlePage : ContentPage
{
    ...
    public static Player InitialPlayer1 { get; internal set; } = new("じぶん", new Debugger());
    public static Player InitialPlayer2 { get; internal set; } = new("あいて", new Debugger());
    Battle Battle;
    ...
    {
        LblAllyName.Text = InitialPlayer1.Name;
        LblFoeName.Text = InitialPlayer2.Name;
        if (InitialPlayer1 is CPUPlayer) BdrAllyCPU.IsVisible = true;
        if (InitialPlayer2 is CPUPlayer) BdrFoeCPU.IsVisible = true;
    }
    ...
    {
        Battle = new(InitialPlayer1.Clone(), InitialPlayer2.Clone())
        {
            In = In,
            Out = Out,
