...
public partial class MatchUpPage : ContentPage
{
    ...
    {
        BattlePage.Player1 = PkrPlayer1.SelectedIndex == 0 ? new Player(Player1Name, Player1Ability) : CPUManager.Create(Player1Name);
        BattlePage.Player2 = PkrPlayer2.SelectedIndex == 0 ? new Player(Player2Name, Player2Ability) : CPUManager.Create(Player2Name);
